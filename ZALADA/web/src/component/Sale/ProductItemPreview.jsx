          ...
          <div className="info">
            <div className="row">
              ...
              <div className="rating hidden-sm col-md-12 pull-left">
                <i className="price-text-color fa fa-star" /><i className="price-text-color fa fa-star" /><i className="price-text-color fa fa-star" /><i className="price-text-color fa fa-star" />
              </div>
            </div>
...
className="btn-add" onClick={() => {
              ...
              ><i className="fa fa-shopping-cart" /><br /><a href="#" className="hidden-sm">Add to cart</a></p>
              <p className="btn-details"><i className="fa fa-list" /><br /><button type="button" className="btn btn-link">{dialog}</button></p>
            </div>
