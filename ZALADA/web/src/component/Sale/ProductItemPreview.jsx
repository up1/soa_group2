          ...
          <div className="info">
            <div className="row">
              <div className="price col-md-12">
                ...
                <h5 className="price-text-color">ราคา {this.props.price}
                  ฿</h5>
              </div>
            ...
            <div className="separator clear-left">
              ...
              <p className="btn-details"><i className="fa fa-list" /><br />
                <button type="button" className="btn btn-link">{dialog}</button>
              </p>
            </div>
